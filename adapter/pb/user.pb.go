...
type User struct {
	...
	CreatedAt string `protobuf:"bytes,5,opt,name=CreatedAt,proto3" json:"created_at" bson:"created_at,omitempty"` // @gotags: bson:"created_at,omitempty",json:"created_at"
	UpdatedAt string `protobuf:"bytes,6,opt,name=UpdatedAt,proto3" json:"updated_at" bson:"updated_at,omitempty"` // @gotags: bson:"updated_at,omitempty",json:"updated_at"
}
